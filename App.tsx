    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
          ...
          <>
            ...
            <div id="products-section" className="container mx-auto px-4 py-12">
              <div className="flex flex-col md:flex-row justify-between items-center mb-8">
                <h2 className="text-3xl font-bold text-ui-blue font-serif mb-4 md:mb-0">Featured Categories</h2>
                <div className="flex gap-2 overflow-x-auto pb-2 w-full md:w-auto scrollbar-hide">
                  {['All', 'Fashion', 'Books', 'Food', 'Electronics', 'Home', 'Services'].map(cat => (
      ...
      <footer className="bg-ui-blue text-white py-8 mt-12">
        <div className="container mx-auto px-4 text-center">
          <p className="opacity-80">© {new Date().getFullYear()} Connect Market.</p>
        </div>
      </footer>
    </div>
  );
